...
function runGradeLoop(grader, tests, code, refreshRate) {
  ...
  */
  ...
  var testLine = React.createClass({displayName: "testLine",
    ...
    render: function() {
      ...
      // var tf = isCorrect;
      return (
        React.createElement("div", null, this.props.testName, " ", React.createElement("span", null, "tf"))
      )
    }
  })

  var GradeDisplay = React.createClass({displayName: "GradeDisplay",
    // getInitialState: function() {
    //   return ()
    // },
    // componentDidMount: function() {
...
//     React.createElement(GradeDisplay, null),
//     document.body
//   );
